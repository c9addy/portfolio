...
//            left: MediaQuery.of(context).size.height * 0.10,
  ...
  Widget _buildProject({double headingFontSize}) {
    return Column(
      mainAxisSize: MainAxisSize.min,
      crossAxisAlignment: CrossAxisAlignment.start,
      children: <Widget>[
        // _buildProjectContainerHeading(fontSize: headingFontSize),
        // SizedBox(height: 8.0),
        _buildProjectTimeline(headingFontSize: headingFontSize)
      ],
    );
  }

  // Widget _buildProjectContainerHeading({double fontSize}) {
  //   return Text(
  //     Strings.education,
  //     style: TextStyles.body.copyWith(fontSize: fontSize),
  //   );
  ...
  Widget _buildProjectTimeline({double headingFontSize}) {
    final widgets = Strings.projectList
        .map(
